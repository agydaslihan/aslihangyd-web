...
export function AramaWidgeti({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-lacivert-yuzey rounded-buton mt-3 flex min-h-13 w-full items-center justify-center gap-2 font-medium text-white transition-opacity hover:opacity-90"
      >
