...
/**
 * ⚠️ WORKER KURULUMU `@/lib/harita/workerAdresi` İÇİNDE — ve oradan
 * içe aktarılması ZORUNLU. MapLibre worker'sız tek bir karo çizemez;
 * gerekçenin tamamı o dosyanın başında.
 *
 * İçe aktarım `WORKER_HAZIR` okunarak görünür kılınıyor: yalnızca yan
 * etkisi için alınan bir modülü paketleyici "kullanılmıyor" sayıp
 * atabilir.
 */
void WORKER_HAZIR
