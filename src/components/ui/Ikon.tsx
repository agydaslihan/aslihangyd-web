...
/** Güneş — tema anahtarında "açık temaya geç". */
export function GunesIkon(ozellikler: IkonOzellikleri) {
  return (
    <Govde {...ozellikler}>
...
/** Ay — tema anahtarında "koyu temaya geç". */
export function AyIkon(ozellikler: IkonOzellikleri) {
  return (
    <Govde {...ozellikler}>
      <path d="M20 14.5A8.5 8.5 0 0 1 9.5 4a7 7 0 1 0 10.5 10.5" />
    </Govde>
  )
}
