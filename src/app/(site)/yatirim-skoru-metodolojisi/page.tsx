        ...
        <article className="max-w-2xl">
          <section>
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              Skor 0–100 arasıdır ve altı bileşenin ağırlıklı ortalamasıdır. Her bileşen kendi
              içinde 0–100&apos;e ölçeklenir.
            </p>
          ...
          <section className="mt-10">
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              <strong className="text-metin font-medium">Kira çarpanı:</strong> düşük çarpan
        ...
        */}
          <section className="mt-10">
            ...
            <p className="text-metin-2 mt-2 leading-relaxed">
              ...
              araç trafiği ve hava kalitesi demektir. Bu yüzden eğri monoton değildir — en yüksek
              puan orta banttadır.
            </p>
                  ...
                  <li key={tip}>
                    ...
                    {ilk && son ? (
                      <span className="text-metin-3">
                        {' '}
                        · {mesafeYaz(ilk.metre)} ve yakınında {ilk.puan} puan,{' '}
                        {mesafeYaz(son.metre)} ve ötesinde {son.puan} puan
                      </span>
                    ) : null}
                  </li>
                )
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              Verisi olmayan kalem puanı{' '}
              <strong className="text-metin font-medium">düşürmez</strong>; hesaptan çıkarılır ve
              mevcut kalemler kendi içinde normalize edilir.
            </p>
            ...
            <p className="text-metin-2 mt-2 leading-relaxed">
              ...
              sistem öneri üretir, danışman değerlendirir ve alanı kendisi doldurur. Veri
              eksikliğinin sessizce olguya dönüşmesine izin vermiyoruz.
            </p>
          </section>
          ...
          <section className="mt-10">
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              ...
              karşılaştırılarak puanlanır: benzer performansta 50 puan, üstünde yüksek, altında
              düşük.
            </p>
            {/*
          ...
          */}
          ...
          <section className="mt-10">
            ...
            <ul className="text-metin-2 mt-3 list-disc space-y-1.5 pl-5 leading-relaxed">
              ...
              <li>
                <strong className="text-metin font-medium">Sosyal donatı:</strong> ilgi noktası
                (POI) yoğunluğu
              </li>
              <li>
                <strong className="text-metin font-medium">Arz baskısı:</strong> devam eden
          ...
          <section className="mt-10">
            ...
            <ul className="text-metin-2 mt-3 list-disc space-y-1.5 pl-5 leading-relaxed">
              ...
              <li>
                Yaşam kalitesi ölçmez — yatırım perspektifinden bakar. Oturmak için en iyi mahalle
                ile yatırım için en iyi mahalle aynı olmayabilir.
              </li>
          ...
          <section className="mt-10">
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              Ağırlıkları değiştirirsek bunu bu sayfada tarih vererek duyururuz. Sessizce
              değiştirilen bir metodoloji, metodoloji değildir.
            </p>
          </section>
