  ...
  return (
    <div className="kapsayici py-10 sm:py-14">
      <article className="max-w-2xl">
        ...
        */}
        <p className="border-kenar bg-yuzey-2 rounded-kart text-metin-2 mt-6 border-[0.5px] p-4 leading-relaxed">
        ...
        <section className="mt-10">
          ...
          <p className="text-metin-2 mt-3 leading-relaxed">
            Haritalardaki <strong className="text-metin font-medium">mahalle sınırları</strong> ile
          ...
          <p className="text-metin-3 text-govde-kucuk mt-3">
            ...
            Mahalle sınırları için de aynısı geçerli: sınırlar idari kaynağın kendisi değil,
            gönüllülerin çizdiği hâlidir ve kaba olabilir. Yanlış gördüğümüz sınırları elle
            düzeltiyoruz; düzeltilenler sonraki içe aktarmalarda korunuyor.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="text-metin-2 mt-3 leading-relaxed">
            ...
            harcına esas alınan <strong className="text-metin font-medium">asgari</strong> değerdir.
            Kamuya açık ve resmî bir veridir.
          </p>

          <p className="text-metin-2 mt-3 leading-relaxed">
            <strong className="text-metin font-medium">Piyasa fiyatı değildir</strong> ve piyasanın
            çoğu yerde altındadır. İkisini karıştırmak sitedeki en yanıltıcı okuma olurdu; bu yüzden
            rayiç bedelin göründüğü her yerde kaynağı ve yılı birlikte yazıyor.
          </p>
        ...
        {googleAcik ? (
          <section className="mt-10">
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              ...
              gösteriliyor. OpenStreetMap işletme saatlerinde zayıf; bu katman o boşluğu dolduruyor.
            </p>
            ...
            <p className="text-metin-2 mt-3 leading-relaxed">
              ...
              yazılmıyor. Bu hem lisans gereği hem de doğru olan: saklanan bir çalışma saati birkaç
              ay içinde yanlışa dönüşür.
            </p>
