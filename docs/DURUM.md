...
| Migration üretim yolu | **kısmen** | Migration'lar **geliştirme veritabanında** koştu. Üretim kabında nasıl çalışacağı belgelenmedi | Kap başlarken migration otomatik koşmuyor; elle adım gerekiyor ve bu yazılı değil |
